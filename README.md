...
Key Findings
Manufacturer risk varies meaningfully. Some manufacturers show a consistently lower average severe injury rate across hundreds of recorded accidents — these should be prioritized in any aircraft purchase shortlist (see the manufacturer ranking in the notebook for specifics).
...
Weather conditions matter. Accidents in instrument (low-visibility) conditions tend to carry higher average fatalities and destroyed-aircraft rates than those in visual conditions — supporting conservative weather-minimum operating policies.
